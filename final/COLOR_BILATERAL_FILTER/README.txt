...
./color_bilateral_filter input.ppm output.ppm 16.0 0.1
...
- 0.1: The 2nd number is the range sigma. The RGB channels are considered
in the [0:1] range.
...
The algorithm described above is in 'color_bilateral_filter.cc'. This
...
- fast_color_bf.h: Provides a fast color bilateral filter.
