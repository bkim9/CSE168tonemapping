...
//  Changed 1/11/02 Frederic Drago
// */
...
// static INLINE void 
// float2rgbe(unsigned char rgbe[4], double red, double green, double blue)
// {
//   float v;
//   int e;
...
// static INLINE void 
// rgbe2float(double *red, double *green, double *blue, unsigned char rgbe[4])
// {
//   double f;
...
// int RGBE_ReadPixels(Image3& img, double *data, int numpixels)
// {
//   unsigned char rgbe[4];
...
// int RGBE_WritePixels_RLE(Image3& img, double *data, int scanline_width,
// 			 int num_scanlines)
// {
//   unsigned char rgbe[4];
...
//     return RGBE_WritePixels(img,data,scanline_width*num_scanlines);
...
// int RGBE_ReadPixels_RLE(Image3& img, double *data, int scanline_width,
// 			int num_scanlines)
// {
...
//     return RGBE_ReadPixels(img,data,scanline_width*num_scanlines);
